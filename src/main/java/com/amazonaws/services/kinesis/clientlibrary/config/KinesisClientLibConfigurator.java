...
public class KinesisClientLibConfigurator {
    ...
    public KinesisClientLibConfiguration getConfiguration(Properties properties) {
        ...
        AWSCredentialsProvider awsCredentialsProviderDynamoDB =
                awsCPPropGetter.decodeValue(properties.getProperty(PROP_CREDENTIALS_PROVIDER_DYNAMODB));
        AWSCredentialsProvider awsCredentialsProviderCloudWatch =
                awsCPPropGetter.decodeValue(properties.getProperty(PROP_CREDENTIALS_PROVIDER_CLOUDWATCH));
        ...
        KinesisClientLibConfiguration config =
                new KinesisClientLibConfiguration(applicationName, streamName, provider, awsCredentialsProviderDynamoDB, awsCredentialsProviderCloudWatch, workerId);
